...
const { predictor, anomaly, advisor, narrator } = require('@flowstate/intelligence');
const { forecastAllZones, forecastConcessions, getIntelligenceSummary } = predictor;
const { getAnomalyReport } = anomaly;
const { askAdvisor, getRecommendations } = advisor;
const { getCurrentNarrative } = narrator;
